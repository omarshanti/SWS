            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">Orphans TABLE</h4>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table text-md-nowrap table-striped" id="example1">
                            <thead>
                            <tr>
                                <th class="wd-15p border-bottom-0">Orphan Code</th>
                                <th class="wd-15p border-bottom-0">Orphan Name</th>
                            ...
                            @foreach($orphans as $orphan)
                                <tr>
                                    ...
                                    <td>{{$orphan->Guardian_En}}</td>
                                    <td>{{$orphan->REL_TO_CHILD_EN}}</td>
                                    <td>{{$orphan->Scale_Of_poverty}}</td>
                                    <td>{{$orphan->CAT}}</td>
                                    <td><a href="{{route('Child.edit',['$Child',$orphan->NO_ORPHAN_CODE])}}" class="btn btn-sm btn-dark">Edit</a>
                                    </td>
                                    <td>
                                        <form action="{{route('Child.destroy',['$Child',$orphan->NO_ORPHAN_CODE])}}" method="post">
                                            @csrf {{-- csrf_field()--}}
                                            @method('delete')
