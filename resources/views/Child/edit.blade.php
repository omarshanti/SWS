                                    ...
                                    <select class="form-control select2-no-search"
                                        ...
                                        @foreach($categories as $category)
                                            <option value="{{ $category }}"
                                                    @if ($child->category == $category) selected @endif>
                                                {{ $category }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-lg-4">
                                    <p class="mg-b-10">Select Scale Of Poverty: </p><select
                                        ...
                                        @foreach($scales as $scale)
                                            <option value="{{$scale}}"
                                                    @if ($child->scale_of_poverty == $scale) selected @endif>{{$scale}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row row-xs">
                                ...
                                <div class="col-md-5 mg-t-10 mg-md-t-0">
                                    ...
                                    <input type="text" id="sponsorship_category" name="sponsorship_category"
                                           ...
                                           value="{{$child->sponsorship_category}}"
                            ...
                            <div class="row row-xs">
                                <div class="col-md-5">
                                    ...
                                    <input type="text" id="father_fullName_en" name="father_fullName_en"
                                           ...
                                           value="{{$child->father_fullName_en}}"
                                ...
                                <div class="col-md-5 mg-t-10 mg-md-t-0">
                                    ...
                                    <input type="text" id="father_fullName_ar" name="father_fullName_ar"
                                           ...
                                           value="{{$child->father_fullName_ar}}"
                            ...
                            <div class="row row-xs">
                                <div class="col-md-5">
                                    ...
                                    <input type="text" id="mother_fullName_en" name="mother_fullName_en"
                                           ...
                                           value="{{$child->mother_fullName_en}}"
                                ...
                                <div class="col-md-5 mg-t-10 mg-md-t-0">
                                    ...
                                    <input type="text" id="mother_fullName_ar" name="mother_fullName_ar"
                                           ...
                                           value="{{$child->mother_fullName_ar}}"
                                ...
                                <div class="col-md-5 mb-3">
                                    ...
                                    <select class="form-control select2-no-search" name="mother_martial_status"
                                        ...
                                        @foreach($mother_martial_status as $status)
                                            <option
                                                value="{{$status}}"
                                                @if ($child->mother_martial_status == $status) selected @endif>{{$status}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row row-xs">
                                <div class="col-md-5">
                                    ...
                                    <input type="text" id="guardian_fullName_en" name="guardian_fullName_en"
                                           ...
                                           value="{{$child->guardian->guardian_fullName_en}}"
                                ...
                                <div class="col-md-5 mg-t-10 mg-md-t-0">
                                    ...
                                    <input type="text" id="guardian_fullName_ar" name="guardian_fullName_ar"
                                           ...
                                           value="{{$child->guardian->guardian_fullName_ar}}"
                                    ...
                                    >
                                        ...
                                        @foreach($relationsEN as $relation)
                                            <option value="{{$relation}}"
                                                    @if ($child->guardian->rel_to_en == $relation) selected @endif
                                            >{{$relation}}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-5 mb-4">
                                    ...
                                    <select
                                        ...
                                        @foreach($relationsAr as $relation)
                                            <option value="{{$relation}}"
                                                    @if ($child->guardian->rel_to_ar == $relation) selected @endif>{{$relation}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row row-xs">
                                <div class="form-group col-lg-3">
                                    ...
                                    <input type="number" id="guardian_id_no" name="guardian_id_no"
                                           value="{{$child->guardian->guardian_id_no}}"
                                ...
                                <div class="form-group col-lg-3">
                                    ...
                                    <select
                                        ...
                                        @foreach($guardian_martial_status as $status)
                                            <option value="{{$status}}"
                                                    @if ($child->guardian->guardian_martial_status == $status) selected @endif>
                                                {{$status}}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group col-lg-3">
                                    ...
                                    <select
                                        ...
                                        @foreach($works as $work)
                                            <option value="{{$work}}"
                                                    @if($child->guardian->work == $work) selected @endif>
                                                {{$work}}
                                            </option>
                                        @endforeach
                                    </select>
                                    ...
                                    <select
                                        ...
                                        @foreach($edu_levels as $edu_level)
                                            <option value="{{$edu_level}}"
                                                    @if($child->guardian->edu_level == $edu_level) selected @endif>
                                                {{$edu_level}}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group col-lg-3">
                                    ...
                                    <select
                                        ...
                                        @foreach($monthly_salary as $salary)
                                            <option value="{{$salary}}"
                                                    @if($child->guardian->monthly_salary == $salary) selected @endif>
                                                {{$salary}}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row-xs">
                                                    ...
                                                    <select class="form-control select2-no-search" name="governorate_id"
                                                        ...
                                                        @foreach($governates as $governorate)
                                                            <option
                                                                ...
                                                                @if ($child->guardian->governorate_id == $governorate->id) selected @endif>{{$governorate->gov_name_en}}</option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <select class="form-control select2" name="area_id"
                                                        ...
                                                        @foreach($areas as $area)
                                                            <option
                                                                value="{{$area->id}}"
                                                                @if ($child->guardian->area_id == $area->id) selected @endif>
                                                                {{$area->area_name_en}}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                ...
                                <div class="control-group form-group mb-0">
                                    ...
                                    <input type="text" id="address_details" name="address_details"
                                           value="{{$child->guardian->address_details}}"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <input type="number" id="members_count" name="members_count"
                                                       value="{{$child->family->members_count}}"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <input type="number" id="members_university" name="members_university"
                                                       value="{{$child->family->members_university}}"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <input type="number" id="members_school" name="members_school"
                                                       value="{{$child->family->members_school}}"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <input type="number" id="members_worker" name="members_worker"
                                                       value="{{$child->family->members_worker}}"
